...
//           {/* Доп. строка только на странице /cvs */}
...
//       {/* Модалки */}
//       {renderModal && activeAction && renderModal(row, closeModal, activeAction)}
//     </>
//   );
// }
...
//           {pathname.includes("/cvs") && (
//             <DropdownMenuItem onClick={() => setIsLinkModalOpen(true)} className="py-2.5 text-blue-600 cursor-pointer">
//               CV
//             </DropdownMenuItem>
//           )}
//         </DropdownMenuContent>
...
//       {isLinkModalOpen && renderModal?.(row, () => setIsLinkModalOpen(false), "link")}
//     </>
//   );
// }
