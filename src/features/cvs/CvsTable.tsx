  ...
  const columns = [
    {
      ...
      className: "cursor-pointer group w-[35%] min-w-[280px]",
        ...
        <div className="flex justify-between flex-row gap-4 items-center w-full mb-6">
          ...
          {props.onCreateClick && (
            <button
              ...
              className="flex-shrink-0 flex items-center justify-center w-10 h-10 md:w-auto md:px-5 md:py-2 text-red-700 rounded-full hover:bg-red-50 dark:hover:bg-red-900/40 transition-colors font-medium text-sm uppercase"
            >
