        ...
        <div className="flex items-center justify-end gap-2 mt-16 pt-6 h-10">
          {isRemoveMode && selectedSkills.length > 0 && (
            <button 
              ...
              disabled={isDeleting}
              className="sm:mr-4 px-3 sm:px-5 py-2 bg-[#C8372D] text-white rounded-lg text-sm font-medium uppercase tracking-wide transition-all duration-200 hover:bg-[#A82B22] hover:shadow-md hover:-translate-y-0.5 active:scale-95 active:translate-y-0 disabled:opacity-50 whitespace-nowrap"
            >
          ...
          <button 
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-lg text-gray-500 font-medium text-sm tracking-wide uppercase transition-all duration-200 hover:bg-gray-100 hover:text-gray-900 active:scale-95 disabled:opacity-30 whitespace-nowrap"
          >
